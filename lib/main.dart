                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text('الطلبات: ${order.orderDetails}', maxLines: 1, overflow: TextOverflow.ellipsis),
                        const SizedBox(height: 8),
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Text('القيمة التقديرية: ${order.estimatedPrice} ر.س',
            ...
            Card(
              ...
              child: Padding(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('معلومات الزبون', style: TextStyle(color: Colors.grey[600], fontWeight: FontWeight.bold)),
                    const SizedBox(height: 5),
                    Text(order.customerName, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                    Text('الجوال: ${order.customerPhone}', style: const TextStyle(fontSize: 16)),
                    const Divider(height: 25),
                    Text('تفاصيل الشراء', style: TextStyle(color: Colors.grey[600], fontWeight: FontWeight.bold)),
                    const SizedBox(height: 5),
                    Text('المتجر: ${order.storeName}', style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w500)),
                    Text('الأغراض: ${order.orderDetails}', style: const TextStyle(fontSize: 16)),
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            Row(
              children: [
                Expanded(child: _buildStatCard('إجمالي الطلبات', '$totalOrders', Colors.blue)),
                const SizedBox(width: 12),
                Expanded(child: _buildStatCard('المنجزة', '$completedOrders', Colors.green)),
              ],
            ),
            const SizedBox(height: 12),
            Row(
